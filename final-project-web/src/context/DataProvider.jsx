...
export const DataProvider = ({ children }) => {
    const [data, setData] = useState({
        ...
        attendees: [
            { id: "1", eventId: "1", firstName: "Charlotte", lastName: "Davis", status: "Accepted" },
            { id: "2", eventId: "1", firstName: "Elijah", lastName: "Garcia", status: "Pending" },
            { id: "3", eventId: "1", firstName: "Sophia", lastName: "Martinez", status: "Declined" },
            { id: "4", eventId: "2", firstName: "Olivia", lastName: "Johnson", status: "Accepted" },
            { id: "5", eventId: "2", firstName: "Ava", lastName: "Jones", status: "Pending" },
            { id: "6", eventId: "2", firstName: "Liam", lastName: "Rodriguez", status: "Accepted" },
            { id: "7", eventId: "2", firstName: "Liam", lastName: "Jones", status: "Declined" },
            { id: "8", eventId: "3", firstName: "Olivia", lastName: "Jones", status: "Accepted" },
            { id: "9", eventId: "3", firstName: "Isabella", lastName: "Jones", status: "Pending" },
            { id: "10", eventId: "3", firstName: "Elijah", lastName: "Martinez", status: "Accepted" },
            { id: "11", eventId: "4", firstName: "Liam", lastName: "Davis", status: "Declined" },
            { id: "12", eventId: "4", firstName: "Sophia", lastName: "Brown", status: "Accepted" },
            { id: "13", eventId: "4", firstName: "Liam", lastName: "Garcia", status: "Pending" },
            { id: "14", eventId: "4", firstName: "Liam", lastName: "Smith", status: "Accepted" },
            { id: "15", eventId: "4", firstName: "Charlotte", lastName: "Jones", status: "Declined" },
            { id: "16", eventId: "5", firstName: "Liam", lastName: "Miller", status: "Accepted" },
            { id: "17", eventId: "5", firstName: "Amelia", lastName: "Martinez", status: "Pending" },
            { id: "18", eventId: "5", firstName: "Emma", lastName: "Rodriguez", status: "Accepted" },
            { id: "19", eventId: "6", firstName: "Emma", lastName: "Davis", status: "Declined" },
            { id: "20", eventId: "6", firstName: "Isabella", lastName: "Garcia", status: "Accepted" },
            { id: "21", eventId: "6", firstName: "Amelia", lastName: "Williams", status: "Pending" },
            { id: "22", eventId: "6", firstName: "Elijah", lastName: "Smith", status: "Accepted" },
        ]        
    });
